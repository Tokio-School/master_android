...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Persona pepe=new Persona(20,"Pepe","123456", ContextCompat.getDrawable(this, R.drawable.foto1));
        Persona maria=new Persona(23,"Maria","555456", ContextCompat.getDrawable(this, R.drawable.foto2));
        Persona juan=new Persona(25,"Juan","123456", ContextCompat.getDrawable(this, R.drawable.foto3));
